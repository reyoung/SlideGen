# *-* coding=utf-8
FILES={
r'''themes\transition/fade.css''':r'''.csstransitions.csstransforms .deck-container .slide {
...
''',
r'''themes\transition/fade.scss''':r'''@mixin translate($x: 0, $y: 0, $z: 0) {
...
r'''extensions\scale/deck.scale.scss''':r'''.csstransforms .deck-container.deck-scale:not(.deck-menu) {
	overflow:hidden;
...
''',
r'''themes\transition/vertical-slide.css''':r'''.csstransitions.csstransforms .deck-container {
  overflow-y: hidden;
}
...
''',
r'''extensions\goto/deck.goto.css''':r'''.deck-container .goto-form {
  position: absolute;
  z-index: 3;
  bottom: 10px;
  left: 50%;
...
''',
r'''themes\style/neon.css''':r'''.deck-container {
...
''',
r'''extensions\menu/deck.menu.scss''':r'''.deck-menu {
	.slide {
		background:#eee;
		position:relative;
		left:0;
...
r'''extensions\menu/deck.menu.css''':r'''.deck-menu .slide {
  background: #eee;
  position: relative;
  left: 0;
  top: 0;
...
''',
r'''extensions\hash/deck.hash.scss''':r'''.deck-container {
	.deck-permalink {
		display:none;
		position:absolute;
		z-index:4;
...
r'''themes\transition/horizontal-slide.scss''':r'''@mixin translate($x: 0, $y: 0, $z: 0) {
	-webkit-transform:translate3d($x, $y, $z);
	-moz-transform:translate($x, $y);
	-ms-transform:translate($x, $y);
	-o-transform:translate($x, $y);
...
r'''extensions\goto/deck.goto.scss''':r'''.deck-container {	
	.goto-form {
		position:absolute;
		z-index:3;
		bottom:10px;
...
''',
r'''themes\style/web-2.0.scss''':r'''@mixin border-radius($r) {
...
''',
r'''extensions\status/deck.status.scss''':r'''.deck-container {
	.deck-status {
		position:absolute;
		bottom:10px;
		right:5px;
...
''',
r'''extensions\scale/deck.scale.css''':r'''.csstransforms .deck-container.deck-scale:not(.deck-menu) {
  overflow: hidden;
}
...
''',
r'''extensions\goto/deck.goto.html''':r'''<!-- Place the following snippet at the bottom of the deck container. -->
...
r'''themes\transition/horizontal-slide.css''':r'''.csstransitions.csstransforms {
  overflow-x: hidden;
}
.csstransitions.csstransforms .deck-container > .slide {
  -webkit-transition: -webkit-transform 500ms ease-in-out;
...
''',
r'''extensions\navigation/deck.navigation.css''':r'''.deck-container .deck-prev-link, .deck-container .deck-next-link {
  display: none;
  position: absolute;
  z-index: 3;
  top: 50%;
...
''',
r'''extensions\status/deck.status.css''':r'''.deck-container .deck-status {
  position: absolute;
  bottom: 10px;
  right: 5px;
  color: #888;
...
r'''extensions\navigation/deck.navigation.scss''':r'''@mixin border-radius($r) {
	-webkit-border-radius:$r;
	-moz-border-radius:$r;
	border-radius:$r;
}
...
''',
r'''themes\style/swiss.css''':r'''.deck-container {
...
''',
r'''extensions\status/deck.status.html''':r'''<!-- Place the following snippet at the bottom of the deck container. -->
<p class="deck-status">
	<span class="deck-status-current"></span>
	/
	<span class="deck-status-total"></span>
</p>''',
r'''core/deck.core.css''':r'''html {
  height: 100%;
}
...
''',
r'''themes\style/neon.scss''':r'''.deck-container {
	font-family: "Gill Sans", "Gill Sans MT", Calibri, sans-serif;
	font-size:1.25em;
	color:#aaa;
	background:#000;
...
''',
r'''themes\style/swiss.scss''':r'''.deck-container {
	font-family: "Helvetica Neue", sans-serif;
	font-size:1.25em;
	background:#fff;
...
''',
r'''extensions\hash/deck.hash.html''':r'''<!-- Place the following snippet at the bottom of the deck container. -->
<a href="." title="Permalink to this slide" class="deck-permalink">#</a>''',
r'''themes\transition/vertical-slide.scss''':r'''@mixin translate($x: 0, $y: 0, $z: 0) {
	-webkit-transform:translate3d($x, $y, $z);
	-moz-transform:translate($x, $y);
	-ms-transform:translate($x, $y);
	-o-transform:translate($x, $y);
...
r'''themes\style/web-2.0.css''':r'''@charset "UTF-8";
.slide .layout_item .layout_unselected {
	color: #f4fafe;
}
.slide .layout_item .layout_selected{
	color: #0B7495;
}
...
''',
r'''extensions\hash/deck.hash.css''':r'''.deck-container .deck-permalink {
  display: none;
  position: absolute;
  z-index: 4;
  bottom: 30px;
...
''',
r'''extensions\navigation/deck.navigation.html''':r'''<!-- Place the following snippet at the bottom of the deck container. -->
